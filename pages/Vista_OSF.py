...
with st.container():
    ...
    <iframe title="RepTec" style="position: absolute; left: 50%; transform: translateX(-50%); height: 541.25px; width: 1140px; border: none;" src="https://app.powerbi.com/view?r=eyJrIjoiYmQ1MDg0NDYtNzM4NS00ZjZmLTk1YjMtNGVjNjJiYWZhZDY2IiwidCI6IjgwOWY3MzcxLTkwZjEtNDBkZC1iNGExLWZlMjM2MTA5ODJmYSIsImMiOjR9" allowFullScreen></iframe>
    </div>
    '''
